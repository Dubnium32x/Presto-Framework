...
Presto-Framework is a 2D game framework inspired by Sonic the Hedgehog, built using [raylib-d](https://github.com/overtools/raylib-d), a D language binding for the raylib library.
...
1. Clone the repository:
    ...
    ```
2. Install [raylib-d](https://github.com/overtools/raylib-d) dependencies.
